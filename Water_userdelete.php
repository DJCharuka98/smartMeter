           ...
           <br>
              ...
              <div class="col-12 col-md-10">
                ...
                <div class="col-12 col-lg-8" style="margin:10px">
                  ...
                  <div class=""><h5 style="background-color:#a0255242; padding:10px;" class="lead">Delete user</h5><div>
                    <?php
                                   ...
                                   {  $us=$_POST['username'];
                                     ...
                                     $dis=$_POST['district'];
                                      ...
                                      $id=(int)$_POST['id'];
                                        ...
                                        $query="DELETE FROM userinfo WHERE id=$id LIMIT 1";

                                      $result=mysqli_query($connection,$query);
                                      if($result)
                                      {
                                         echo '<div  class="alert alert-success alert-dismissible fade show" role="alert">',"User details are deleted!",
                                          '<button type="button" class="close" data-dismiss="alert" area-label="true">',
                                          '<span area-hidden="true">&times</span>','</button>','</div>';
                                      }
                                      else {
                  ...
                  <div style="padding:10px; background-color:white">
                      <form class="" action="#" method="post">
                            ...
                            <input required placeholder="NIC" class="form-control" id="NIC" name="NIC" value=<?php echo $array['NIC'];?>>
                          </div>
                          <div class="form-group col-4">
                  ...
                  <button type="submit" class="btn btn-success lead" style="width:100px" name="dlt">Delete</button>
