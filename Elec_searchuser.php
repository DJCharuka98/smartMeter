                  ...
                  <div class="col-12 col-lg-6">
                    <div  style="margin:15px;"><h5>Search user</h5>
                      ...
                      <div class="col-12">
                        ...
                        {
                        $query="SELECT id,username,NIC,email,contact,address,city,district,Elecaccount_no FROM userinfo";
                        ...
                        if($result_set)
                        {
                          ...
                          <th scope="col">CEB Account</th></tr>';
                                ...
                                $table.='<td>'.$record['contact'].'</td>';
                                 $table.='<td>'.$record['address'].'</td>';
                                  $table.='<td>'.$record['city'].'</td>';
                                   ...
                                   $table.='<td>'.$record['Elecaccount_no'].'</td>';
                                   $table.='</tr>';
                      ...
                      else if(isset($_POST['query']) && (!$_POST['username']==""))
                      {
                        ...
                        $query="SELECT id,username,NIC,email,contact,address,city,district,Elecaccount_no FROM userinfo WHERE username=:username";
                                 ...
                                 $table.='<td>'.$record["0"]['address'].'</td>';
                                  $table.='<td>'.$record["0"]['city'].'</td>';
                                   $table.='<td>'.$record["0"]['district'].'</td>';
                                    $table.='<td>'.$record["0"]['Elecaccount_no'].'</td>';
                                   $table.='</tr>';
                                   echo $table;
