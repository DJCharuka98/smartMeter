...
$connection=mysqli_connect('localhost','root','','userinfo');
          ...
          $query="INSERT INTO userinfo (username,password,NIC,email,address,city,district,contact,Elecaccount_no) VALUES
          ('{$_POST["username"]}','{$password}','{$_POST["NIC"]}','{$_POST["email"]}','{$_POST["address"]}',
            '{$_POST["city"]}','{$_POST["state"]}','{$_POST["contact"]}','{$_POST["eac"]}')";
